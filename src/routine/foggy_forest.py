...
MOSTER_TEMPLATES = utils.load_templates_from_folder('assets/routine/foggy_forest/the_book_ghost/')

REAL_PLAYER_TEMPLATES = utils.load_templates_from_folder('assets/routine/foggy_forest/real_player/')
