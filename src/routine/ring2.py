...
npc = cv2.imread('assets/routine/ring2/npc.png', 0)
fight_req = cv2.imread('assets/routine/ring2/fight_request.png', 0)
tomb = cv2.imread('assets/routine/ring2/tomb.png', 0)
three = cv2.imread('assets/routine/ring2/three.png', 0)
four = cv2.imread('assets/routine/ring2/four.png', 0)

threshold = 0.98

# BOT_TEMPLATE_LF = cv2.imread('assets/routine/ring2/bot_lf.png', 0)
# BOT_TEMPLATE_RT = cv2.imread('assets/routine/ring2/bot_rt.png', 0)
# HORSE_TEMPLATE_LF = cv2.imread('assets/routine/ring2/horse_lf.png', 0)
# HORSE_TEMPLATE_RT = cv2.imread('assets/routine/ring2/horse_rt.png', 0)
# SUMMON_TEMPLATE = cv2.imread('assets/routine/ring2/summon_loc.png', 0)
TP_TEMPLATE = cv2.imread('assets/routine/ring2/tp.png', 0)

REAL_PLAYER_TEMPLATE = cv2.imread('assets/routine/ring2/real_player.png', 0)
is_alt = False
alt_has_died = False
